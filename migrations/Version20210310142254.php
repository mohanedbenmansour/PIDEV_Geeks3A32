 ...
 */
final class Version20210310142254 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6499D1C3019 FOREIGN KEY (participant_id) REFERENCES tournoi (id)');
